      ...
      ws_message_action({
        "m2m:dbg": {
          ...
          message: {
            ...
            SenValue:
              '[{"MsgID":1,"TargetID":2,"PositionX":0,"PositionY":7,"PositionZ":0,"BPM":117,"HBR":46,"Therm":0,"rsv":0,"Engergy":5575,"Point":0,"Type":0,"status":1,"v1":0,"v2":0,"y1":0,"y2":0}]',
          },
        },
      });
    } else if (jsonObj["m2m:dbg"].status === "SUCCESS") {
